    ...
    <div className="relative pt-24">
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-white md:text-5xl">Everything SpaceMap can do</h1>
          <p className="mx-auto mt-4 max-w-2xl text-space-dim">
            From real-time satellite tracking to conjunction detection, every tool you need for
            orbital awareness is built into a single browser tab.
          </p>
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#4d96e8]/10 to-[#8ed8ff]/5 p-12 backdrop-blur-sm">
            <h2 className="text-2xl font-bold text-white md:text-3xl">See it all in action</h2>
