...
export function SavedList() {
  ...
  return (
    <aside className="spacemap-overlay pointer-events-auto absolute bottom-24 right-16 z-10 flex max-h-[calc(100vh-14rem)] w-[400px] flex-col overflow-hidden rounded-md border border-space-border bg-space-panel/90 backdrop-blur">
