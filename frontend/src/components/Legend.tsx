...
export function Legend() {
  return (
    <div className="pointer-events-auto absolute bottom-4 left-4 z-10 rounded-md border border-space-border bg-space-panel/85 p-3 text-xs backdrop-blur">
      <div className="mb-2 text-[9px] uppercase tracking-widest text-space-dim">Orbit class</div>
        ...
        {ORDER.map(({ key, label }) => (
          <div key={key} className="flex items-center gap-2">
            <span
              ...
              style={{
                background: ORBIT_CLASS_COLOR[key],
                boxShadow: `0 0 6px ${ORBIT_CLASS_COLOR[key]}`,
              }}
            />
