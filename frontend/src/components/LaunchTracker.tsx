...
export function LaunchTracker() {
  ...
  return (
    <aside className="spacemap-overlay pointer-events-auto absolute bottom-28 right-44 z-10 flex max-h-[36vh] w-[400px] flex-col overflow-hidden rounded-2xl border border-space-border bg-space-panel/92 shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl">
