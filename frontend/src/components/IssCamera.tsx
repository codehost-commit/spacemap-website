...
export function IssCamera() {
  ...
  return (
    <aside className="spacemap-overlay pointer-events-auto absolute bottom-24 left-4 z-10 w-[420px] rounded-md border border-space-border bg-space-panel/95 backdrop-blur">
