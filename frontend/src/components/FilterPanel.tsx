...
export function FilterPanel() {
  ...
  return (
    <aside className="spacemap-filter pointer-events-auto absolute right-4 top-24 z-20 max-h-[calc(100vh-7rem)] w-[19.25rem] overflow-y-auto rounded-2xl border border-space-border bg-space-panel/92 p-3 font-mono text-xs shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl">
      <ImageryPicker />
      <SectionHeader
        label="Orbit class"
        action={
