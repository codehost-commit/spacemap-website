...
export function TelemetryPanel() {
  ...
  if (selected == null) {
    return (
      <aside className="spacemap-telemetry pointer-events-auto absolute right-40 top-20 z-10 w-[400px] rounded-2xl border border-space-border bg-space-panel/92 p-4 text-xs shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl">
  ...
  return (
    <aside className="spacemap-telemetry pointer-events-auto absolute right-40 top-20 z-10 flex max-h-[55vh] w-[400px] flex-col overflow-hidden rounded-2xl border border-space-border bg-space-panel/92 shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl">
