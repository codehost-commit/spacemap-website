...
export function TelemetryPanel() {
  ...
  return (
    <aside className="spacemap-telemetry pointer-events-auto absolute right-44 top-24 z-10 flex max-h-[36vh] w-[400px] flex-col overflow-hidden rounded-2xl border border-space-border bg-space-panel/92 shadow-[0_18px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl">
